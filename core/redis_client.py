...
class RedisClient:
    ...
    def read_stream(self, stream_name: str, consumer_group: str, consumer_name: str, 
    ...
    def set_session_status(self, session_id: str, status_data: Dict[str, Any], expire_seconds: int = 3600):
    ...
    def update_session_status(self, session_id: str, updates: Dict[str, Any]):
        ...
        try:
            ...
            logger.debug(f"Updated status for session {session_id}: {list(updates.keys())}")
    ...
    def get_pending_messages(self, stream_name: str, consumer_group: str) -> list:
        ...
        try:
            pending = self.client.xpending_range(stream_name, consumer_group, '-', '+', 10)
            return pending
        except Exception as e:
